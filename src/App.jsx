...
const LIFE_TIMELINE = [
  ...
  { mya: 2400, label: "Great Oxidation Event", icon: "💨", color: "#88ccee", cat: "geo",
    desc: "Cyanobacteria flood the atmosphere with O₂. Most anaerobic life goes extinct. Oxygen enables ozone layer formation, shielding land from UV radiation." },
  { mya: 2000, label: "Eukaryotes emerge", icon: "🧬", color: "#cc44aa", cat: "bio",
    desc: "The first cell with a nucleus and mitochondria is created. This unleashes entirely new evolutionary possibilities: sex, multicellularity, complexity." },
  { mya: 541, label: "Cambrian Explosion", icon: "🐚", color: "#44ccaa", cat: "bio",
    desc: "In ~20 million years, virtually all major animal body plans appear. Eyes, limbs, predation, nervous systems, evolution's greatest diversification event. Possibly triggered by rising oxygen and ecological niche races." },
  ...
  { mya: 0.3, label: "Homo sapiens", icon: "👁️", color: "#f0e0c0", cat: "bio",
    desc: "Modern humans evolve in Africa, develop language, art, and abstract thought. Within 300,000 years we decode DNA, split the atom, and send spacecraft beyond the solar system. Intelligence emerges for possibly the first time in the universe." },
];
...
const DRAKE_PARAMS = [
  { id: "R", label: "Star formation rate", unit: "stars/yr", min: 0.1, max: 10, default: 3, log: false,
    desc: "Rate of star formation in the Milky Way. Current estimates: 1-7 new stars per year." },
  { id: "fp", label: "Fraction with planets", unit: "", min: 0, max: 1, default: 0.95, log: false,
    desc: "Close to 100% of sun-like stars host planets based on Kepler mission data. Planetary systems are the rule, not the exception." },
  { id: "ne", label: "Habitable zone planets/star", unit: "", min: 0, max: 5, default: 0.4, log: false,
    desc: "Planets in the habitable zone per planetary system. Estimates range from 0.1 to 2+ depending on stellar type. Around 22% of sun-like stars host Earth sizes planets in their habitable zone." },
  ...
  { id: "L", label: "Civilization lifespan", unit: "years", min: 100, max: 1e9, default: 10000, log: true,
    desc: "How long does a technological civilization survive? One of the important components of the Fermi paradox." },
];
...
const SOLAR_PLANETS = [
  { name: "Mercury", period: 0.241,  radius: 3,   color: "#b5a99a", dist: 0.39,  moons: 0,
    desc: "The smallest planet and closest to the Sun. Surface temperatures swing from -180°C to 430°C. No atmosphere and scarred by craters. Likely has water ice in permanently shadowed polar craters.",
  ...
  { name: "Earth",   period: 1.000,  radius: 6.5, color: "#4fa3e0", dist: 1.00,  moons: 1,
    desc: "The only confirmed life-bearing world. Liquid water covers 71% of the surface. Active plate tectonics recycles carbon, stabilizing climate over billions of years. The Moon stabilizes axial tilt, possibly crucial for life. Our only current data point for confirmed life.",
  ...
  { name: "Jupiter", period: 11.86,  radius: 14,  color: "#c88b3a", dist: 5.20,  moons: 95,
    desc: "Its gravity deflects many comets away from Earth. Moon Europa has a subsurface ocean with more water than all Earth's oceans combined, heated by tidal flexing from Jupiter's gravity.",
  ...
  { name: "Uranus",  period: 84.01,  radius: 9,   color: "#7de8e8", dist: 19.19, moons: 28,
    desc: "An ice giant knocked on its side, axial tilt of 98°. The coldest planetary atmosphere at -224°C. Less studied than other outer planets; a prime target for future missions.",
  ...
  { name: "Neptune", period: 164.8,  radius: 8,   color: "#3f54ba", dist: 30.07, moons: 16,
    desc: "Moon Triton was captured from the Kuiper Belt and has active nitrogen geysers, possibly the most geologically surprising moon in the outer solar system. Internal ocean possible.",
